...
python3 ./tests/myworld/test-world-editor-definition-browser.py
...
python3 ./tests/myworld/test-native-blocked-void-npc-roam.py
python3 ./tests/myworld/test-native-blocked-void-movement.py
python3 ./tests/myworld/test-installed-world-builder-client-bootstrap.py
...
python3 ./tests/myworld/test-current-base-skill-state.py
...
python3 ./tests/myworld/test-world-editor-lockdown.py
