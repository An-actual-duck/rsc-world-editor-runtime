...
class WorldEditorFoundationTest(unittest.TestCase):
    ...
    def test_layered_builder_allocation_is_explicit_live_and_sparse(self):
        ...
        self.assertIn("and activated it live.", commands)
        self.assertNotIn("Save and reopen the Builder", commands)
        ...
        self.assertLess(provisioned, teleported)
    ...
    def test_scenery_and_npc_tools_use_authoritative_editor_protocol(self):
        ...
        self.assertIn("and activated it live.", commands)
        self.assertNotIn("Save and reopen the Builder before navigating there", commands)
    ...
    def test_world_editor_dispatcher_accepts_only_supported_envelope_lengths(self):
        ...
        self.assertEqual({13, 15, 19, 22, 29, 32, 42, 43}, accepted)
